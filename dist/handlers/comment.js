...
var likePost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.default.like.create({
                        data: {
                            postId: postId,
                            userId: userId,
                        },
...
var commentPost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var postId, text, userId, comment, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                postId = req.params.postId;
